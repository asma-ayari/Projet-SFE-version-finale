...
def _enrich_with_images(questions: List[dict]) -> None:
    """
    ...
    for i, question in enumerate(questions):
        ...
        if not image_desc:
            _LOGGER.debug("⚠️ Question %d has no image_description, skipping", i)
            continue

        try:
            # Récupérer l'image via Unsplash
            ...
            # Continue avec la prochaine question au lieu de lever une exception
