...
export class Dashboard implements OnInit, AfterViewInit {
  ...
  navItems: FormateurNavItem[] = [
    { label: 'FORMATEUR.NAV.DASHBOARD', icon: 'fas fa-home', route: '/formateur/dashboard' },
    { label: 'FORMATEUR.NAV.MANAGE_COURSES', icon: 'fas fa-cog', route: '/formateur/cours' },
    { label: 'FORMATEUR.NAV.MANAGE_VIDEOS', icon: 'fas fa-film', route: '/formateur/videos-manage' },
    { label: 'FORMATEUR.NAV.MY_PROFILE', icon: 'fas fa-user', route: '/formateur/profile' }
  ];
  ...
  private loadTotalPublishedVideos(): void {
    ...
    this.videoService.listPublishedVideos()
      .subscribe({
        next: (videos) => {
