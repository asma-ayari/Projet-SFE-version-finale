...
يساعد فهم هذه المراحل على فهم سبب اعتماد السلامة على الطريق على جميع هذه العوامل.`
    ...
    {
      lessonNumber: 8,
      title: 'Temps de réaction réel sur la route',
      content: `Page 8/9

APPLIQUER LE TEMPS DE RÉACTION À LA RÉALITÉ ROUTIÈRE

Les tests précédents montrent des temps rapides (0,3-1 sec) mais ce n'est qu'en CONDITION OPTIMALE.

Sur la route, c'est TRÈS différent.
