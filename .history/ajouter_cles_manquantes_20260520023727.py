...
FILES = [
    "frontend/Plateforme-Securite-Routiere-master/src/assets/i18n/fr.json",
    "frontend/Plateforme-Securite-Routiere-master/src/public/i18n/fr.json",
    "frontend/Plateforme-Securite-Routiere-master/public/i18n/fr.json",
]
