...
import { timeout, finalize, Subscription } from 'rxjs';
...
export class QcmGenerateComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.langSub = this.translate.onLangChange.subscribe((event) => {
            this.language = event.lang as 'fr' | 'ar';
            this.selectedThemes = [];
